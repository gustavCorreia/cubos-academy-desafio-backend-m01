...
//? Input Format: A entrada é um string armazenado na variável cartaParaCima que indica qual carta ficou virada para cima. Será sempre uma das opções: Q, J, K, A, 2, 3.

//? Output Format: Imprima na tela qual é a manilha desta partida. Sua resposta deve ser sempre uma das opções: Q, J, K, A, 2, 3.
...
const solucao = (carta) => {
    let cartas = ['Q', 'J', 'K', 'A', '2', '3', 'Q'],
        manilha = cartas.indexOf(carta) + 1;
    console.log(cartas[manilha]);
};
