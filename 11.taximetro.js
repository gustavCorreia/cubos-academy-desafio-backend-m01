...
//? Input Format: A entrada é composta por duas variáveis: - min representa quantos minutos de duração a viagem teve. É sempre um número inteiro. - km representa quantos quilômetros foram percorridos na viagem. Pode ser um número com casas decimais.

//? Output Format: Imprima na tela um único inteiro que representa o valor que deve ser pago pelo cliente, em centavos.

//? Sample Input 0: 25 11.5.

//? Sample Output 0: 1925;

//* Resposta;
const solucao = (min, km) => {
    let valorMin = 20 * 50,
        valorMinAdicional = (min - 20) * 30,
        valorKm = 10 * 70,
        valorKmAdicional = (km - 10) * 50;

    let valorMinTotal = min <= 20 ? min * 50 : valorMinAdicional + valorMin,
        valorKmTotal = km <= 10 ? km * 70 : valorKmAdicional + valorKm;
    console.log(valorMinTotal + valorKmTotal);
};
